...
void medoidsham(struct list *  ,int ,int ,struct node * ,int );
void medoidscos(struct list * ,int ,int,struct node * ,int );
void medoidseucl(struct list *  ,int ,int ,struct node * ,int );
void medoidsmatr(struct list * ,int ,struct node * ,int );
